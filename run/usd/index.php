...
$BTC = round($json->BTC->USD,2);
$ETH = round($json->ETH->USD,2);
$DOGE = round($json->DOGE->USD,2);
$DASH = round($json->DASH->USD,2);
$IOT = round($json->IOT->USD,2);
$XMR = round($json->XMR->USD,2);
$LTC = round($json->LTC->USD,2);
$XRP = round($json->XRP->USD,2);
$ZEC = round($json->ZEC->USD,2);
$XLM = round($json->XLM->USD,2);
$ETC = round($json->ETC->USD,2);
$NEO = round($json->NEO->USD,2);
